...
Playground level13 = {
  ...
  { { 3, 3 }, { FieldValue::Box, FieldValue::Target } },
  { { 4, 3 }, { FieldValue::Space } },
  { { 5, 3 }, { FieldValue::Player } },
  { { 6, 3 }, { FieldValue::Wall } },
  ...
  { { 3, 4 }, { FieldValue::Box, FieldValue::Target } },
  ...
  { { 3, 5 }, { FieldValue::Box, FieldValue::Target } },
  ...
  { { 1, 6 }, { FieldValue::Wall } },
  { { 2, 6 }, { FieldValue::Wall } },
  { { 3, 6 }, { FieldValue::Box, FieldValue::Target } },
  ...
  { { 2, 7 }, { FieldValue::Wall } },
  { { 3, 7 }, { FieldValue::Space, FieldValue::Target } },
  { { 4, 7 }, { FieldValue::Wall } },
  { { 5, 7 }, { FieldValue::Wall } },
